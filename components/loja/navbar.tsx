    ...
    <nav className="bg-kc-cream border-b border-kc-line sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
        ...
        <Link href="/" className="flex flex-col shrink-0">
          <span className="font-serif text-lg font-medium text-kc-dark tracking-[0.12em] leading-none">
            KARY
          </span>
          <span className="text-[9px] tracking-[0.28em] text-kc-muted">
            CURADORIA
          </span>
        </Link>
        ...
        <div className="hidden md:flex gap-7">
          {navLinks.map(({ href, label }) => (
            <Link
              key={label}
              href={href}
              className="text-[11px] tracking-[0.16em] text-kc-muted hover:text-kc-dark transition-colors uppercase"
            >
              {label}
            </Link>
          ))}
        ...
        <div className="md:hidden border-t border-kc-line bg-kc-cream">
          {navLinks.map(({ href, label }) => (
            <Link
              ...
              className="block px-6 py-3.5 text-[11px] tracking-[0.16em] text-kc-muted hover:text-kc-dark hover:bg-kc-light transition-colors uppercase border-b border-kc-line last:border-0"
            >
              {label}
            </Link>
          ))}
