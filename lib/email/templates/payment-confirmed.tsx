                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style={{ backgroundColor: "#5C3317", padding: "32px 40px", textAlign: "center", borderRadius: "8px 8px 0 0" }}>
                        ...
                        <div style={{ margin: "16px auto 8px", width: 56, height: 56, backgroundColor: "#A0622A", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center" }}>
                          <span style={{ color: "#EDE8DC", fontSize: 28 }}>✓</span>
                        </div>
                        <h1 style={{ margin: "8px 0 0", color: "#EDE8DC", fontSize: 26, fontWeight: 400 }}>
                          Pagamento Aprovado!
                        </h1>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style={{ backgroundColor: "#FFFFFF", padding: "40px", borderRadius: "0 0 8px 8px" }}>
                        ...
                        <p style={{ margin: "0 0 32px", color: "#5C3317", fontSize: 15, lineHeight: 1.6 }}>
                          Seu pagamento do pedido <strong>#{orderNumber}</strong> foi aprovado. Estamos preparando seu pedido para envio!
                        </p>

                        {/* Badge */}
                        <div style={{ backgroundColor: "#EDE8DC", borderLeft: "4px solid #A0622A", borderRadius: 4, padding: "16px 20px", marginBottom: 32 }}>
                          <p style={{ margin: 0, color: "#5C3317", fontSize: 15, fontWeight: 600 }}>
                            Próximo passo: Separação e envio
                          </p>
                          <p style={{ margin: "4px 0 0", color: "#B89070", fontSize: 13 }}>
                        ...
                        <table width="100%" cellPadding={0} cellSpacing={0} style={{ borderCollapse: "collapse", marginBottom: 24 }}>
                          ...
                          <tfoot>
                            <tr style={{ borderTop: "2px solid #EDE8DC" }}>
                              <td colSpan={2} style={{ padding: "12px", color: "#5C3317", fontSize: 15, fontWeight: 700 }}>Total</td>
                              <td style={{ padding: "12px", color: "#5C3317", fontSize: 15, fontWeight: 700, textAlign: "right" }}>{formatCurrency(total)}</td>
                            </tr>
                          </tfoot>
                        </table>
